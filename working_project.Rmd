...
```{r Herd Size & Time of Day - Scatter, warning=FALSE, message=FALSE}
...
```
```{r Phases of the Moon, warning=FALSE, message=FALSE}
knitr::include_graphics(here("Images", "moon_phases.png"))
```

```{r Herd Size & Moon Phase - Scatter, warning=FALSE, message=FALSE}
...
```{r Moon Phase & Time of Day - Scatter, warning=FALSE, message=FALSE}
...
```{r Month & Time of Day - Scatter, warning=FALSE, message=FALSE}
...
```{r Month & Moon Phase - Scatter, warning=FALSE, message=FALSE}
...
```{r Moon Phase & Time of Day - Heatmap, warning=FALSE, message=FALSE}
...
```
```{r Camera ID & Time of Day - Heatmap, warning=FALSE, message=FALSE}
