...
```{r Visual Plot, echo=FALSE, fig.cap='Figure 1. Deer Sightings by Hour over March', message=FALSE, warning=FALSE}
deer_data <- deer_data %>%
...
```{r Histogram, echo=FALSE, fig.cap='Figure 2. Histogram of Deer Sightings by Hour documented in Spring 2023', message=FALSE, warning=FALSE}
...
*This image of the Duke Forest (Duke University, n.d.) provides a good locational framework for understanding the locations we will be discussing in this project.*
