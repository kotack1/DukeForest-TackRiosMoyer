...
### Group Size Scatter Plots

```{r Group Size & Time of Day, warning=FALSE, message=FALSE}
#scatter plot of group size and time of day
deer.timeofday <- 
  ggplot(deer_cam_data, aes(x = start_time, y = group_size)) +
  geom_point() +
  geom_smooth(method = lm, color="black") +
  labs(
    title = "Group Size of Deer Seen on Camera Based on Time of Day",
    x = "Time of Day (hour)",
    y = "Group Size"
  ) +
  custom.theme()

print(deer.timeofday)
```

```{r Group Size & Moon Phase, warning=FALSE, message=FALSE}
#scatter plot of group size and time of day
deer.moonphase <- 
  ggplot(deer_cam_data, aes(x = moon_phase, y = group_size)) +
  geom_point() +
  labs(
    title = "Group Size of Deer Seen on Camera Based on Moon Phase",
    x = "Moon Phase",
    y = "Group Size"
  ) +
...
```{r Moon Phase & Time of Day, warning=FALSE, message=FALSE}
#scatter plot of group size and time of day
deer.moonphase.time <- 
  ...
  geom_smooth(method = lm, color="black") +
  labs(
    title = "Deer Seen on Camera Based on Moon Phase and Time of Day",
    x = "Moon Phase",
    y = "Time of Day (hour)"
  ) +
  custom.theme()

print(deer.moonphase.time)
```


```{r Month & Time of Day, warning=FALSE, message=FALSE}
#scatter plot of group size and time of day
deer.time.month <- 
  ...
  geom_smooth(method = lm, color="black") +
  labs(
    title = "Deer Seen on Camera Based on Month & Time of Day",
    x = "Month",
    y = "Time of Day (hour)",
    color = "Group Size"
  ) +
...
```{r Month & Time of Day Heatmap, warning=FALSE, message=FALSE}
deer.month.time.heatmap <- 
  ggplot(deer_cam_data, aes(x = moon_phase, y = start_time, fill = group_size)) +
  geom_tile() +
  scale_fill_gradient(low = "yellow", high = "red") +
  labs(
    title = "Heatmap of Moon Phase & Time of Day, by Group Size",
    x = "Moon Phase",
    y = "Time of Day (hour)",
    color = "Group Size"
  ) +
...
print(deer.month.time.heatmap)
```
```{r Cam ID & Time of Day Heatmap, warning=FALSE, message=FALSE}
deer.cam.time.heatmap <- 
  ggplot(deer_cam_data, aes(x = start_time, y = cam_id, fill = group_size)) +
  geom_tile() +
  scale_fill_gradient(low = "yellow", high = "red") +
  labs(
    title = "Heatmap of Time of Day & Camera ID, by Group Size",
    x = "Time of Day (hour)",
    y = "Camera ID",
    color = "Group Size"
  ) +
...
```{r Cam ID & Time of Day Heatmap, warning=FALSE, message=FALSE}
deer.time.month <- 
  ggplot(deer_cam_data, aes(x = start_date, y = division, color = moon_phase)) +
  geom_point() +
  labs(
    title = "Deer Seen on Camera Based on Month & Time of Day",
    x = "Month",
    y = "Division",
    color = "Time of Day (hour)"
  ) +
  custom.theme()
